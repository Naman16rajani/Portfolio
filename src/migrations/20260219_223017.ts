...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "abouts" ADD CONSTRAINT "abouts_img_url_id_media_id_fk" FOREIGN KEY ("img_url_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "resume" ADD CONSTRAINT "resume_pdf_file_id_media_id_fk" FOREIGN KEY ("pdf_file_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "projects" ADD CONSTRAINT "projects_img_url_id_media_id_fk" FOREIGN KEY ("img_url_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_resume_fk" FOREIGN KEY ("resume_id") REFERENCES "public"."resume"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "abouts_img_url_idx" ON "abouts" USING btree ("img_url_id");
  ...
  CREATE INDEX "resume_pdf_file_idx" ON "resume" USING btree ("pdf_file_id");
  CREATE INDEX "resume_updated_at_idx" ON "resume" USING btree ("updated_at");
  CREATE INDEX "resume_created_at_idx" ON "resume" USING btree ("created_at");
  ...
  CREATE INDEX "projects_img_url_idx" ON "projects" USING btree ("img_url_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_resume_id_idx" ON "payload_locked_documents_rels" USING btree ("resume_id");
